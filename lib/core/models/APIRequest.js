...
exports.APIRequest = Request.extend({
  ...
  fieldnames: "bucket primaryKey revision properties relations application returnData".w(),
  
  requestType: null,
  
  init: function(){
    switch(this.requestType){
      case C.ACTION_FETCH: this.fieldnames.push('conditions','parameters'); break;
