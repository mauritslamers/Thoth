...
if (typeof console === 'undefined') {
  global.console = {} ;
  console.log = console.info = console.warn = console.error = sys.log;
  console.inspect = sys.inspect;
}
...
// normally you wouldn't have SC as a global object in node, but in this case it is really
// helpful in porting...
...
SC.mixin = function() {
  ...
  args.unshift(true);
  return this._baseMixin.apply(this, args);
} ;
...
SC.mixin(/** @scope SC */ {
  ...
  */
  isEqual: function(a,b) {
    ...
    var type_a = typeof a;
    var type_b = typeof b;
    if(((type_a === SC.T_NUMBER) || (type_a === SC.T_STRING) || type_a === SC.T_BOOLEAN) && type_a === type_b){ // prevent primitive hashFor
      return a === b;
    } else
    if (a === null) {
      return b === null ;
...
// this is probably not necessary, though it is part of the bootstrap
//<script language="JavaScript" type="text/javascript" src="sc/bootstrap/setup_body_class_names.js"> </script>
//<script language="JavaScript" type="text/javascript" src="sc/bootstrap/system/browser.js"> </script>   
//<script language="JavaScript" type="text/javascript" src="sc/bootstrap/system/loader.js"> </script>





// now require all stuff that is necessary for runtime to work
...
/*
<script language="JavaScript" type="text/javascript" src="sc/runtime/private/observer_set.js"> </script>   
<script language="JavaScript" type="text/javascript" src="sc/runtime/mixins/observable.js"> </script>
<script language="JavaScript" type="text/javascript" src="sc/runtime/system/enumerator.js"> </script>   
<script language="JavaScript" type="text/javascript" src="sc/runtime/mixins/enumerable.js"> </script>
<script language="JavaScript" type="text/javascript" src="sc/runtime/system/range_observer.js"> </script>
<script language="JavaScript" type="text/javascript" src="sc/runtime/mixins/array.js"> </script> 
<script language="JavaScript" type="text/javascript" src="sc/runtime/mixins/comparable.js"> </script> 
<script language="JavaScript" type="text/javascript" src="sc/runtime/mixins/copyable.js"> </script>    
<script language="JavaScript" type="text/javascript" src="sc/runtime/mixins/delegate_support.js"> </script>
<script language="JavaScript" type="text/javascript" src="sc/runtime/mixins/freezable.js"> </script>  
<script language="JavaScript" type="text/javascript" src="sc/runtime/system/set.js"> </script>
<script language="JavaScript" type="text/javascript" src="sc/runtime/system/object.js"> </script>
<script language="JavaScript" type="text/javascript" src="sc/runtime/private/chain_observer.js"> </script>  
<script language="JavaScript" type="text/javascript" src="sc/runtime/private/observer_queue.js"> </script>

<script language="JavaScript" type="text/javascript" src="sc/runtime/protocols/observable_protocol.js"> </script>
<script language="JavaScript" type="text/javascript" src="sc/runtime/protocols/sparse_array_delegate.js"> </script> 
<script language="JavaScript" type="text/javascript" src="sc/runtime/system/binding.js"> </script> 
<script language="JavaScript" type="text/javascript" src="sc/runtime/system/error.js"> </script>  
<script language="JavaScript" type="text/javascript" src="sc/runtime/system/index_set.js"> </script>
<script language="JavaScript" type="text/javascript" src="sc/runtime/system/logger.js"> </script> 
<script language="JavaScript" type="text/javascript" src="sc/runtime/system/run_loop.js"> </script>
<script language="JavaScript" type="text/javascript" src="sc/runtime/system/selection_set.js"> </script>
<script language="JavaScript" type="text/javascript" src="sc/runtime/system/sparse_array.js"> </script>
*/
