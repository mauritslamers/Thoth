...
exports.Store = SC.Object.extend({
   ...
   */
   ...
   createRelation: function(){
     // the callback expects a record
     console.log("This function needs an implementation. If you are seeing this message, you are probably using the base or extended ThothStore without relation mixin.");     
   },
