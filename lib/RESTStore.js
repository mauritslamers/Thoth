...
exports.RESTStore = Store.extend({
  ...
  fetchDBRecords: function(storeRequest,clientId,callback){
    var urlWithPrefix = ["http://",this.RESTHost,":",this.RESTPort,"/",this.RESTPrefix,"/",storeRequest.bucket.pluralize()].join("");
    var urlSansPrefix = ["http://",this.RESTHost,":",this.RESTPort,"/",storeRequest.bucket.pluralize()].join("");
