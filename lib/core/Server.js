...
exports.Server = SC.Object.extend({
  ...
  createHTTPHandler2: function(serverObj){
...
// ===========================   
  ...
  GET: function(request,response){
    ...
    cb = function(records){
      ...
      if(records){
        ...
        me._sentHTTPJSONResponse(request,response, res);
      }
    };
    ...
    if(resource.length === 1){ // fetchall
      req = API.createStoreRequest({ bucket: resource[0], primaryKey: urlInfo.query.primaryKey || API.getPrimaryKey() },
        this.sessionModule.getUserData(receivedUserName),
  ...
  // - POST of a record (POST to resource, with a body of a createRecordRequest) 
