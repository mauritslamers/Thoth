...
exports.RESTStore = Store.extend({
  ...
  RESTBaseURL: 'http://', // no trailing slash
  RESTHost: 'localhost',
  RESTPort: 80,
  RESTPrefix: '',
  ...
  fetchDBRecords: function(storeRequest,clientId,callback){
    var urlWithPrefix = [this.RESTBaseURL,this.RESTHost,":",this.RESTPort,"/",this.RESTPrefix,"/",storeRequest.bucket.pluralize()].join("");
    var urlSansPrefix = [this.RESTBaseURL,this.RESTHost,":",this.RESTPort,"/",storeRequest.bucket.pluralize()].join("");
