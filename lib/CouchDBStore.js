...
exports.CouchDBStore = Store.extend({
  ...
  */
  ...
  createRelationDesign: function(junctionInfo,callback){
    ...
    function as string: 
    var funcHeader = "function(doc){ emit(";
    var sideOneProp = "doc." + junctionInfo.modelRelationKey;
    var sideTwoProp = "doc." + junctionInfo.relationRelationKey;
    var funcFooter = "); }";
    
    var sideOneMap = [funcHeader,sideOneProp,",",sideTwoProp,funcFooter].join("");
    var sideTwoMap = [funcHeader,sideTwoProp,",",sideOneProp,funcFooter].join("");
