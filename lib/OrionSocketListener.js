  ...
  sendData: function(userData,dataToSend){
     ...
     // first get the client fitting the user data and then send the dataToSend
      ...
      if(client && client.isConnected){
         ...
         this.OrionServer.sessionModule.queueRequest(userData.user,userData.sessionKey,dataToSend);
      }
  ...
  start: function(server, options){
	...
	*/
	...
	_onClientDisconnect: function(client){
	   sys.log('OrionSocketListener: _onClientDisconnect called for client with name ' + client.user + " and sessionKey " + client.sessionKey);
