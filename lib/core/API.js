...
exports.RelationReply = require('./models/RelationReply').RelationReply;   
exports.ErrorReply = require('./models/ErrorReply').ErrorReply;       
exports.RecordReply = require('./models/RecordReply').RecordReply;
...
exports.createAPIRequest = function(storeRequest,action,returnData){
  ...
  sys.log('WARNING createAPIRequest is deprecated....');
...
exports.createStoreRequest = function(APIRequest,userData,action){
  ...
  //sys.log('WARNING createStoreRequest is deprecated....');
  // this function is being used by the session module....
...
exports.createDataReply = function(storeRequest,action,data){ // data = object with either recordData in it or a relationSet
  ...
  sys.log('WARNING createDataReply is deprecated....');
...
exports.createErrorReply = function(action,error,returnData){   
  ...
  sys.log('WARNING createErrorReply is deprecated....');
	var ret, msg;
...
var relationSchema = {
  ...
  "properties": {
    ...
    "oppositeType": {"type":["string","undefined","null"], "enum":["toOne","toMany",null,undefined], "required": false}, // 
    ...
    "bucket": {"type":"string","required":false}, // in case of an isNested: true... no idea how to properly enforce this...
    "primaryKey": {"type":"string","required":true},
    "relationKey": {"type":"string","required": false},
    "keys": {"type":["number","string","array","undefined"], "required":false},
    "propertyName": {"type":"string","required":true},
    "propertyKey": {"type": ["string","null","undefined"], "required": false} // in case the propertyName !== propertyKey
  }
};
...
var APICreateRecordRequest = {
  ...
  "extends":baseAPIRequest,
  "properties": {
    "key": { "type": ["string","number","null"], "required": false },
    "revision": {"type":["string","number","null"], "required":false },
...
var APIFetchRelationResult = {
  ...
  "properties": {
    "relationSet": {
      ...
      "items": {
        "bucket": {"type":"string", "required": true },
        "keys": {"type": ["array","string","number"] }, // this array contains a set of keys of records the data in the data parameter belongs to
        "propertyName": {"type":"string"},
        "propertyKey": {"type": ["string","null","undefined"], "required": false},
        "data": {"type":"object"} 
        // an object having the keys in the keys array as properties and either keys or complete objects as value (if isChildRecord)
      }
    },
...
var APIRecordReply = {
  ...
  "properties": {  
    "bucket": {"type":"string", "required":true},
    "key": {"type":["number","string"], "required":true},
    "record": {"type":["object","null"], "required":true},
    "returnData": {"type":"object"}
  }
};

var APIRefreshRelationReply = APIFetchRelationResult;  
...
APISCHEMAS[Constants.ACTION_RECORD_REPLY] = APIRecordReply;
//APISCHEMAS[Constants.ACTION_REFRESH_REPLY] = APIRefreshReply;
APISCHEMAS[Constants.ACTION_REFRESH_RELATION_REPLY] = APIRefreshRelationReply;     
//APISCHEMAS[Constants.ACTION_CREATE_REPLY] = APICreateReply;
APISCHEMAS[Constants.ACTION_RPC] = APIRPCRequest;
...
//exports.JSV = JSV;
//exports.JSVEnv = JSV.createEnvironment();
//exports.JSVEnv = require('json-validate');
exports.JSVEnv = require('./json_validator').JSONValidate.create();
/*
