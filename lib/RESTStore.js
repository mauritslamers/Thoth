...
exports.RESTStore = Store.extend({
  ...
  fetchDBRecords: function(storeRequest,clientId,callback){
    ...
    var urlWithPrefix = ['/',this.RESTHost,":",this.RESTPort,"/",this.RESTURLPrefix,"/",storeRequest.bucket.pluralize()].join("");
    var urlSansPrefix = ['/',this.RESTHost,":",this.RESTPort,"/",storeRequest.bucket.pluralize()].join("");
    var url = this.RESTPrefix? urlWithPrefix : urlSansPrefix;
