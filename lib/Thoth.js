...
Thoth.mixins = {
  junctionRelations: require(corePath + '/mixins/junctionrelations').RelationsByJunctionTable,
  storeActions: require(corePath + '/mixins/store_actions').StoreActionCreators,
  computedPropertyCalculator: require(corePath + '/mixins/computed_property_calculator').ComputedPropertyCalculator
};
