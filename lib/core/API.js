...
exports.RelationResult = require('./models/FetchRelationResult').RelationResult;   
exports.ErrorReply = require('./models/ErrorReply').ErrorReply;       
exports.RefreshRecordReply = require('./models/RefreshRecordReply').RefreshRecordReply;
