...
var apitest = base.vows.describe("API basic tests");
...
apitest.addBatch({
  'API module': {
    ...
    'should have getPrimaryKey function': function(m){
      assert.isFunction(m.getPrimaryKey);
    },
    
    'should have createAPIRequest function': function(m){
      assert.isFunction(m.createAPIRequest);
    },
    
    'should have createStoreRequest function': function(m){
      assert.isFunction(m.createStoreRequest);
    },
    
    'should have hasInconsistency function': function(m){
      assert.isFunction(m.hasInconsistency);
    },
    
    'should have createDataReply function': function(m){
      assert.isFunction(m.createDataReply);
    },
    
    'should have createErrorReply function': function(m){
      assert.isFunction(m.createErrorReply);
    },
    
    'should have createAuthReply function':function(m){
      assert.isFunction(m.createAuthReply);
    }
  }
});
