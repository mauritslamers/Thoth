...
exports.Session = SC.Object.extend({
    ...
    { @user: 
      {
        @sessionKey: {
          ...
          // sessionObj is retrieved from cache and added in runtime
        }
      }
    }
  ...
  */
  ...
  saveSessionObject: function(username,sessionKey,record,callback){
    ...
    var cache = this.getUserCache(username,sessionKey);
    if(cache){
