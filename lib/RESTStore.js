...
exports.RESTStore = Store.extend({
  ...
  createDBRecord: function(storeRequest,clientId,callback){
    ...
    if(data){
      ...
      //dataToSend = 'params=[' + escape(JSON.stringify(data) + ']'); 
      ...
      request = httpClient.request('POST',url,headers);               
      sys.log('RESTStore: sending data to back end: ' + dataToSend);
      ...
      sys.log('no data for createDBRecord');
    }
  },
