...
exports.createAuthReply = function(role,sessionKey,message){
	...
	if(sessionKey){ //success
		ret = { authSuccess: { role: authResult.role, sessionCookie: receivedSessionKey}};
	}
	else {
		//no success
...
relations: [ { propertyName: '', type: 'toOne', isMaster: YES, bucket: ''}, { propertyName: '', type: 'toMany', bucket: ''}]}} // isMaster needs rethink
