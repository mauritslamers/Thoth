...
*/
exports.Server = SC.Object.extend(httpResponses,{
    ...
    var methodDispatch = function(request,response){
      ...
      if(method !== 'GET'){
        ...
        request.addListener("end", function(){
           serverObj[method](request,reqdata,response); // finish gathering, call method function
        });
      }
      else {
    ...
    cb = function(records){
      ...
      if(records){
        if(records.recordResult){
          me.send200(response, { fetchResult: { 
             bucket: resource[0], 
          ...
          if(records.refreshResult){
            me.send200(response, { refreshRecordResult: { bucket: resource[0], key: resource[1], record: records.refreshResult } 
            },'application/json');            
          }
          else {
            me.send200(response, API.createErrorReply(Constants.ACTION_REFRESH,Constants.ERROR_DATAINCONSISTENCY));
          }
        }        
      }
      else {
