...
//      formAction : '/thoth/upload',   // This will have the upload cacheKey appended
//      autoSubmit: YES,                // Fire when ready
//      numberOfFiles: 1,
//      isProgressive: NO,              // There will only be one input button
...
//
//       ...someUploadPopup.getPath('contentView.filefieldView').createForm(data.cacheKey);
//
...
//
//       This url becomes: "/thoth/upload/SOME_CACHE_KEY?X-Progress-ID=SOME_UUID"
//
//  When the input button on the form is clicked, the url is submitted. For development, you 
//  need a proxy for /upload as you probably already have for /thoth. For example, 
//
//    proxy '/thoth', :to => 'localhost:8080'
//    proxy '/upload', :to => 'localhost'
//
//    proxy '/thoth' does the normal proxy setup for /thoth,
//    and proxy '/upload' goes to localhost where nginx is configured to proxy, in turn, to the
//    absolute file path for the .../upload dir, where node-formidable will put the files.
//
