  ...
  fetch: function(storeRequest,clientId,callback){
    ...
    var merge = function(records,relSets){
      ...
      var relSetMap = function(relSet){
        //if(me.isProfiling) profiler.startProfiling('ThothSC_Store_fetch_merge_' + relSet.propertyName);  
        ...
        //if(me.isProfiling) profiler.stopProfiling('ThothSC_Store_fetch_merge_' + relSet.propertyName);
      };
    ...
    var finishFetch = function(){
      ...
      //if(me.isProfiling) profiler.startProfiling('ThothSC_Store_fetch_finishFetch');
      if(me.isProfiling){
        //profiler.stopProfiling('ThothSC_Store_fetch_finishFetch');
