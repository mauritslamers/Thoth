...
exports.OrionDBStore = Store.extend(JunctionMixin,{
      ...
      */
      ...
      createDBRecord: function(storeRequest,clientId,callback){
         ...
         var request = this.createOrionDBHTTPRequest('POST',storeRequest.bucket,null,storeRequest.record,function(data){
      ...
      updateDBRecord: function(storeRequest,clientId,callback){
         ...
         var request = this.createOrionDBHTTPRequest('PUT',storeRequest.bucket,storeRequest.key,storeRequest.record,function(data){
      ...
      deleteDBRecord: function(storeRequest,clientId,callback){
         ...
         var request = this.createOrionDBHTTPRequest('DELETE',storeRequest.bucket,storeRequest.key,storeRequest.record,
            function(value){
