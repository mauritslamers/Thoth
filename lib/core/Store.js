  ...
  fetch: function(storeRequest,clientId,callback){
    ...
    var relationCb = function(relIndex){
      ...
      return function(data){
        sys.log('relationCb: combineReturnCalls: ' + me.combineReturnCalls);
        if(!me.combineReturnCalls) callback({ relationSet: data }); // first give back the info
