...
exports.CouchDBStore = Store.extend({
  ...
  debug: YES, // set to yes to have node-couchDB show the actual HTTP calls it performs in the Thoth Log.
      
  getClient: function(){
    return CouchDB.createClient(this.port, this.host, this.user, this.pass);
  },
